# Rollback for Test 03 — removes the customer created by test_03_newsletter.ps1.
# Windows equivalent of test_03_newsletter_rollback.sh.
#
# Usage:
...
Write-Host '========================================='
Write-Host ' ROLLBACK 03 — Newsletter Signup'
Write-Host '========================================='
Write-Host ''
...
Write-Host '--- Action: delete test customer ---'
